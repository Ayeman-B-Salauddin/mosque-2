    ...
    <>
      ...
      >
        <h2 id="accordion-collapse-heading-1">
          ...
          >
            <span>What is the management structure at GLMCC?</span>
            <svg
              data-accordion-icon
        ...
        <h2 id="accordion-collapse-heading-2">
          ...
          >
            <span>How are trustees selected?</span>
            <svg
              data-accordion-icon
        ...
        <h2 id="accordion-collapse-heading-3">
          ...
          >
            <span>
              How do you ensure that management are transparent and accessible
              to the congregation?
            </span>
            <svg
              data-accordion-icon
